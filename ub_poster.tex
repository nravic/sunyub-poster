...
%   TITLE SECTION 
%----------------------------------------------------------------------------------------
\title{\Huge UB\\ Beamer Poster} % Poster title
\author{Author 1, Author 2, Author 3}
\institute{Department of Mechanical and Aerospace Engineering, State University of New York at Buffalo\\\vspace{4mm}
\texttt{\{author1,author2,author3\}@buffalo.edu}}
